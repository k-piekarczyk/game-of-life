gol: make-o/gifenc.o make-o/lodepng.o make-o/game_configuration.o make-o/game_functions.o make-o/game_space_display.o make-o/game_space_management.o make-o/main.o
